...
if(is_post_request()) {
  ...
  redirect_to(url_for('/staff/subject/index.php?id='. h(u($page['subject_id']))));
...
<div id="content">
 ...
 <a class="back-link" href="<?php echo url_for('/staff/subject/show.php?id='.h(u($page['subject_id']))); ?>">&laquo; Back to Subject Page</a>
