...
redirect_to(url_for('staff/subject/show.php?id='. $new_id));
 ...
 $subject_set = find_all_subjects();
  $subject_count= mysqli_num_rows($subject_set) +1; // this is coz you're adding a new row so plus 1
...
<?php echo display_errors($errors);?>
    <form action="<?php echo url_for('/staff/subject/new.php'); ?>" method="post">
      <dl>
        <dt>Menu Name</dt>
